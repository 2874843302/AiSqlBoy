...
const require$$2$2 = require("stream");
...
electron.ipcMain.handle("get-saved-connections", async () => {
  return internalDB.getConnections();
});
electron.ipcMain.handle("save-connection", async (_, config) => {
  return internalDB.saveConnection(config);
});
electron.ipcMain.handle("delete-connection", async (_, id) => {
  return internalDB.deleteConnection(id);
});
electron.ipcMain.handle("connect-db", async (_, config) => {
  try {
    if (currentDriver) {
...
electron.ipcMain.handle("get-databases", async () => {
...
electron.ipcMain.handle("use-database", async (_, dbName) => {
...
electron.ipcMain.handle("get-table-data", async (_, tableName, limit, offset, orderBy, orderDir) => {
...
electron.ipcMain.handle("get-table-columns", async (_, tableName) => {
  if (!currentDriver) return [];
  try {
...
electron.ipcMain.handle("get-table-indexes", async (_, tableName) => {
  if (!currentDriver) return [];
  try {
...
electron.ipcMain.handle("rename-table", async (_, oldName, newName) => {
  if (!currentDriver) return { success: false, error: "Not connected" };
  try {
...
electron.ipcMain.handle("delete-table", async (_, tableName) => {
  if (!currentDriver) return { success: false, error: "Not connected" };
  try {
...
electron.ipcMain.handle("create-table", async (_, tableName, columns, indexes) => {
  if (!currentDriver) return { success: false, error: "Not connected" };
  try {
...
electron.ipcMain.handle("update-table-schema", async (_, tableName, changes) => {
  if (!currentDriver) return { success: false, error: "Not connected" };
  try {
...
electron.ipcMain.handle("export-database", async (_, includeData) => {
  if (!currentDriver) return { success: false, error: "Not connected" };
  try {
...
electron.ipcMain.handle("delete-database", async (_, dbName) => {
  if (!currentDriver) return { success: false, error: "Not connected" };
  try {
...
electron.ipcMain.handle("execute-query", async (_, sql) => {
  if (!currentDriver) return { success: false, error: "Not connected" };
  try {
